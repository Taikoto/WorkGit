...
if($number ne 31){
    die "\nInvalid parameters, param number must be 31.\n\n";
}
...
my @param = (
  ...
  # ["Modem_LTE_DELTANV"     , ${ARGV[$index+20]}        , 1        , 1        , 0        , 0x0       , 0xFFFFFFFF  ],
  ...
  #["FDL_WCN"       , ${ARGV[$index+9]}  , 1        , 1,        , 1        , 0x0       , 0xFFFFFFFF  ],
   ["Modem_WCN"     , ${ARGV[$index+9]}  , 1        , 1,        , 1        , 0x0       , 0xFFFFFFFF  ],
   ["BOOT"          , ${ARGV[$index+10]} , 1        , 1,        , 0        , 0x0       , 0xFFFFFFFF  ],
  #["Trustos"       , ${ARGV[$index+12]} , 1        , 1,        , 0        , 0x0       , 0xFFFFFFFF  ],
 ...
 #  ["SysInfo"       , ${ARGV[$index+18]} , 1        , 1         , 0        , 0x0       , 0xFFFFFFFF  ],
   #["Persist"       , ${ARGV[$index+18]} , 1        , 1         , 0        , 0x0       , 0xFFFFFFFF  ],
   ["Modem_LTE_DELTANV"     , ${ARGV[$index+18]}        , 1        , 1        , 0        , 0x0       , 0xFFFFFFFF  ],
   ["SML"           , ${ARGV[$index+19]} , 1        , 1,        , 0        , 0x0       , 0xFFFFFFFF  ],
   #["Vendor"        , ${ARGV[$index+21]} , 1        , 1,        , 0        , 0x0       , 0xFFFFFFFF  ],
   ["Trustos"       , ${ARGV[$index+20]} , 1        , 1,        , 0        , 0x0       , 0xFFFFFFFF  ],
   ["GPS_BD"       , ${ARGV[$index+21]} , 1        , 1,        , 0        , 0x0       , 0xFFFFFFFF  ],
   ["GPS_GL"       , ${ARGV[$index+22]} , 1        , 1,        , 0        , 0x0       , 0xFFFFFFFF  ],
   ["ProdNV"        , ${ARGV[$index+23]}        , 1        , 1        , 0        , 0x0       , 0xFFFFFFFF  ],
   ["System"        , ${ARGV[$index+24]}        , 1        , 1        , 0        , 0x0       , 0xFFFFFFFF  ],
   ["UserData"      , ${ARGV[$index+25]}        , 1        , 1        , 0        , 0x0       , 0xFFFFFFFF  ],
   ["Cache"         , ${ARGV[$index+26]}        , 1        , 1        , 1        , 0x0       , 0xFFFFFFFF  ],
...
if($use_fast_CRC == 1)
{
	...
	{
		print "Windows os\n";
		$szPara = "$Current_ProcDir/UpdatedPacCRC_Win.exe ".$pac_file;
		#die "\ncompute crc failed.\n" if (system("UpdatedPacCRC_Win.exe ".$pac_file));
	}
	else
	{
		print "Linux os\n";
		$szPara = "$Current_ProcDir/UpdatedPacCRC_Linux ".$pac_file;
